...
E verifique se existe esta linha (ou adicione, se necessário):
...
azzor1337x.shop → acessa seu blog

azzor1337x.shop/admin → acessa o painel do Pi-hole

💡 Dica: use o Cloudflare Tunnel para expor isso externamente e configure os paths corretamente no Cloudflare, se necessário.

Quer que eu te ajude a adicionar isso à documentação?
